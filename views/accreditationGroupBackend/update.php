...
$this->breadcrumbs = [
    ...
    $model->name => ['/accreditation/accreditationGroupBackend/view', 'id' => $model->id],
    Yii::t('AccreditationModule.accreditation', 'Редактирование'),
];

$this->pageTitle = Yii::t('AccreditationModule.accreditation', 'Группы аккредитации - редактирование');
...
<div class="page-header">
    <h1>
        <?=  Yii::t('AccreditationModule.accreditation', 'Редактирование') . ' ' . Yii::t('AccreditationModule.accreditation', 'Группу аккредитации'); ?>        <br/>
