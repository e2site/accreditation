...
<fieldset>
    <div class="row">
		...
		<div class="col-sm-3">
            <?=  $form->textFieldGroup($model, 'template', [
                'widgetOptions' => [
                    'htmlOptions' => [
                        'class' => 'popover-help',
                        'data-original-title' => $model->getAttributeLabel('template'),
                        'data-content' => $model->getAttributeDescription('template')
                    ]
                ]
            ]); ?>
        </div>
		<div class="col-sm-3">
            <?=  $form->textFieldGroup($model, 'is_barcode', [
                'widgetOptions' => [
                    'htmlOptions' => [
                        'class' => 'popover-help',
    ...
    <?php $this->widget(
        'bootstrap.widgets.TbButton', [
            ...
            'encodeLabel' => false,
            'buttonType'  => 'submit',
            'label'       => '<i class="fa fa-search">&nbsp;</i> ' . Yii::t('AccreditationModule.accreditation', 'Искать Группу аккредитации'),
        ]
    ); ?>
