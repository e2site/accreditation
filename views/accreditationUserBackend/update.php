...
$this->breadcrumbs = [
    ...
    $model->id => ['/accreditation/accreditationUserBackend/view', 'id' => $model->id],
    Yii::t('AccreditationModule.accreditation', 'Редактирование'),
];

$this->pageTitle = Yii::t('AccreditationModule.accreditation', 'Аккредитаций - редактирование');
...
<div class="page-header">
    <h1>
        <?=  Yii::t('AccreditationModule.accreditation', 'Редактирование') . ' ' . Yii::t('AccreditationModule.accreditation', 'Аккредитацию'); ?>        <br/>
